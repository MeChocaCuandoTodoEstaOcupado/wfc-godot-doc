...
En el desarrollo de videojuegos un Asset son los recursos que se utiliza como modelos 3D, musica, código entre otros. Estos suelen estar publicados para proyectos usando algún motor de videojuegos especifico para ser compatible.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/arbolproblema.png}
...
\begin{enumerate}
\item Investigar algoritmos para la generación de mapas
...
Al momento de avanzar en el procedimiento se definió que el proceso a seguir necesitaría ser un proceso ágil para poder avanzar evitando interrupciones y acomodarse a necesidades surgentes en el desarrollo.
...
\hline 
        ...
        Nro. Objetivo Específico & Actividades & Recursos Necesarios &Resultados a obtener \\ \hline 
         ...
         1& Investigación de la implementación de algoritmos de generación procedural y seeding &  & Diseño de algoritmos a usar\\ \hline 
